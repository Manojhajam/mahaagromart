...
export const subcategories: Record<string, string[]> = {
  "Fruits & Vegetables": ["Fresh Fruits", "Exotic Fruits", "Leafy Vegetables", "Root Vegetables"],
  "Food Products": ["Spices", "Snacks", "Pickles", "Honey", "Ready to Eat"],
  "Millets": ["Jowar", "Bajra", "Ragi", "Nachni"],
  Fertilizers: ["Organic Fertilizers", "Chemical Fertilizers"],
  Pesticides: ["Organic Pesticides", "Chemical Pesticides"],
  Seeds: ["Vegetable Seeds", "Fruit Seeds", "Grain Seeds"],
  "Combo Packs": [],
  Gardening: ["Tools", "Pots & Planters", "Soil & Compost"],
  "Dairy & Eggs": ["Milk", "Cheese", "Butter", "Paneer", "Eggs"],
  Oils: ["Cooking Oil", "Essential Oil"],
  "Dry Fruits": ["Almonds", "Cashews", "Raisins", "Pistachios", "Walnuts"],
  "Grains & Rice": ["Rice", "Wheat", "Coarse Grains"],
