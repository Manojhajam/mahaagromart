...
const page = () => {
  return (
    <div className='bg-gray-100 h-screen'>
        <div className='flex flex-col items-center justify-center h-70 bg-gradient-to-r from-primary-light to-primary text-white mt-4'>
        ...
        <div className='flex flex-col md:flex-row items-center justify-around gap-8 mt-8 p-4'>
            <div className='w-full md:flex-1 flex flex-col items-center justify-center bg-white text-primary-light shadow-2xl rounded-lg py-6'>
